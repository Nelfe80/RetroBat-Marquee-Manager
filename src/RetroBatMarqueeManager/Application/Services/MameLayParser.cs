        ...
        public static MameLayout Parse(string layFilePath)
        {
            ...
            try
            {
                ...
                foreach (var elemNode in root.Elements("element"))
                {
                    ...
                    {
                        layout.Warnings.Add($"Element '{name}' ignored: only <image> elements are supported.");
                    }
                }
                ...
                foreach (var viewNode in root.Elements("view"))
                {
                    ...
                    foreach (var viewElemNode in viewNode.Elements("element"))
                    {
                        ...
                        {
                            layout.Warnings.Add($"View '{name}' element ignored: missing ref or bounds.");
                        }
                    }
            ...
            {
                layout.Warnings.Add($"Layout parse error: {ex.Message}");
            }
