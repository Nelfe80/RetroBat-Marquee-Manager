...
public sealed record LightingSurfaceOptions(bool TestPattern, int FpsLimit, bool ShowFps, double RenderScale, double FillHeightMaxCrop, bool SoundEnabled, double SoundVolume, double GlassReflection, double TubeVisualOpacity, double TubeThickness = 1.0, double TubeBlur = 1.0, double TubeEndFade = 0.10, string TubeColor = "#FFE0B2", bool LatestWinsGeneration = true, bool MapCache = true, bool PresentPipeline = true, bool GpuRaster = false);
