...
// Dynamic is appended LAST so existing numeric serializations stay stable.
public enum SourceKind { Personal, UserDrop, Generated, Scraped, Logo, SystemFallback, Dynamic }
